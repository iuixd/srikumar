...
function App() {
  ...
  return (
    <>
      <div className="justify-center self-auto items-center w-full h-screen mt-0 flex static bg-[linear-gradient(to_bottom,_rgba(0,_192,_199,_0.5),_rgba(0,_192,_199,_0.5))]">
